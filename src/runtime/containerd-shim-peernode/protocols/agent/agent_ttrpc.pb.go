...
type AgentServiceService interface {
	...
	GetVolumeStats(context.Context, *VolumeStatsRequest) (*grpc.VolumeStatsResponse, error)
...
func (c *agentserviceClient) GetVolumeStats(ctx context.Context, req *VolumeStatsRequest) (*grpc.VolumeStatsResponse, error) {
	var resp grpc.VolumeStatsResponse
