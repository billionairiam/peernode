...
import (
	...
	protocols "github.com/billionairiam/peernode/src/runtime/containerd-shim-peernode/protocols"
	grpc "github.com/billionairiam/peernode/src/runtime/containerd-shim-peernode/protocols/grpc"
...
type CreateContainerRequest struct {
	...
	PidFile      string `protobuf:"bytes,1,opt,name=pid_file,json=pidFile,proto3" json:"pid_file,omitempty"`
	Detach       bool   `protobuf:"varint,2,opt,name=detach,proto3" json:"detach,omitempty"`
	NoPivot      bool   `protobuf:"varint,3,opt,name=no_pivot,json=noPivot,proto3" json:"no_pivot,omitempty"`
	NoNewKeyring bool   `protobuf:"varint,4,opt,name=no_new_keyring,json=noNewKeyring,proto3" json:"no_new_keyring,omitempty"`
	// Extra file paths instead of *os.File
	ExtraFiles []string `protobuf:"bytes,5,rep,name=extra_files,json=extraFiles,proto3" json:"extra_files,omitempty"`
	// Extra arguments
...
func (x *CreateContainerRequest) GetPidFile() string {
	if x != nil {
		return x.PidFile
	}
	return ""
...
func (x *CreateContainerRequest) GetDetach() bool {
	if x != nil {
		return x.Detach
	}
	return false
...
func (x *CreateContainerRequest) GetNoPivot() bool {
	if x != nil {
		return x.NoPivot
	}
	return false
...
func (x *CreateContainerRequest) GetNoNewKeyring() bool {
	if x != nil {
...
func (x *CreateContainerRequest) GetExtraFiles() []string {
	if x != nil {
		return x.ExtraFiles
	}
	return nil
...
func (x *CreateContainerRequest) GetExtraArgs() []string {
	if x != nil {
		return x.ExtraArgs
	}
	return nil
...
type ExecProcessRequest struct {
	...
	Process     *grpc.Process          `protobuf:"bytes,4,opt,name=process,proto3" json:"process,omitempty"`
...
func (x *ExecProcessRequest) GetProcess() *grpc.Process {
	if x != nil {
		return x.Process
	}
	return nil
...
type UpdateContainerRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ContainerId   string                 `protobuf:"bytes,1,opt,name=container_id,json=containerId,proto3" json:"container_id,omitempty"`
	Resources     *grpc.LinuxResources   `protobuf:"bytes,2,opt,name=resources,proto3" json:"resources,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateContainerRequest) GetResources() *grpc.LinuxResources {
	if x != nil {
		return x.Resources
	}
	return nil
...
const file_agent_proto_rawDesc = "" +
	"\n" +
	"\vagent.proto\x12\x04grpc\x1a\toci.proto\x1a\tcsi.proto\x1a\vtypes.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x19google/protobuf/any.proto\"\xcc\x01\n" +
	"\x16CreateContainerRequest\x12\x19\n" +
	"\bpid_file\x18\x01 \x01(\tR\apidFile\x12\x16\n" +
	"\x06detach\x18\x02 \x01(\bR\x06detach\x12\x19\n" +
	"\bno_pivot\x18\x03 \x01(\bR\anoPivot\x12$\n" +
	"\x0eno_new_keyring\x18\x04 \x01(\bR\fnoNewKeyring\x12\x1f\n" +
	"\vextra_files\x18\x05 \x03(\tR\n" +
	"extraFiles\x12\x1d\n" +
	"\n" +
	"extra_args\x18\x06 \x03(\tR\textraArgs\":\n" +
	...
	"\x14_compact_force_times2\x94\x16\n" +
	"\fAgentService\x12G\n" +
	...
	"\x1eRemoveStaleVirtiofsShareMounts\x12+.grpc.RemoveStaleVirtiofsShareMountsRequest\x1a\x16.google.protobuf.Empty\x12A\n" +
	"\n" +
	...
	"\tSetPolicy\x12\x16.grpc.SetPolicyRequest\x1a\x16.google.protobuf.EmptyBWZUgithub.com/billionairiam/peernode/src/runtime/containerd-shim-peernode/protocols/grpcb\x06proto3"
...
var file_agent_proto_goTypes = []any{
	...
	(*grpc.Process)(nil),                          // 72: grpc.Process
	(*grpc.LinuxResources)(nil),                   // 73: grpc.LinuxResources
	(*protocols.Interface)(nil),                   // 74: types.Interface
	(*protocols.Route)(nil),                       // 75: types.Route
	(*protocols.ARPNeighbor)(nil),                 // 76: types.ARPNeighbor
	(protocols.FSGroupChangePolicy)(0),            // 77: types.FSGroupChangePolicy
	(*emptypb.Empty)(nil),                         // 78: google.protobuf.Empty
	(*grpc.VolumeStatsResponse)(nil),              // 79: grpc.VolumeStatsResponse
}
var file_agent_proto_depIdxs = []int32{
	57, // 0: grpc.ExecProcessRequest.string_user:type_name -> grpc.StringUser
	72, // 1: grpc.ExecProcessRequest.process:type_name -> grpc.Process
	73, // 2: grpc.UpdateContainerRequest.resources:type_name -> grpc.LinuxResources
	11, // 3: grpc.CpuStats.cpu_usage:type_name -> grpc.CpuUsage
	12, // 4: grpc.CpuStats.throttling_data:type_name -> grpc.ThrottlingData
	15, // 5: grpc.MemoryStats.usage:type_name -> grpc.MemoryData
	15, // 6: grpc.MemoryStats.swap_usage:type_name -> grpc.MemoryData
	15, // 7: grpc.MemoryStats.kernel_usage:type_name -> grpc.MemoryData
	70, // 8: grpc.MemoryStats.stats:type_name -> grpc.MemoryStats.StatsEntry
	17, // 9: grpc.BlkioStats.io_service_bytes_recursive:type_name -> grpc.BlkioStatsEntry
	17, // 10: grpc.BlkioStats.io_serviced_recursive:type_name -> grpc.BlkioStatsEntry
	17, // 11: grpc.BlkioStats.io_queued_recursive:type_name -> grpc.BlkioStatsEntry
	17, // 12: grpc.BlkioStats.io_service_time_recursive:type_name -> grpc.BlkioStatsEntry
	17, // 13: grpc.BlkioStats.io_wait_time_recursive:type_name -> grpc.BlkioStatsEntry
	17, // 14: grpc.BlkioStats.io_merged_recursive:type_name -> grpc.BlkioStatsEntry
	17, // 15: grpc.BlkioStats.io_time_recursive:type_name -> grpc.BlkioStatsEntry
	17, // 16: grpc.BlkioStats.sectors_recursive:type_name -> grpc.BlkioStatsEntry
	13, // 17: grpc.CgroupStats.cpu_stats:type_name -> grpc.CpuStats
	16, // 18: grpc.CgroupStats.memory_stats:type_name -> grpc.MemoryStats
	14, // 19: grpc.CgroupStats.pids_stats:type_name -> grpc.PidsStats
	18, // 20: grpc.CgroupStats.blkio_stats:type_name -> grpc.BlkioStats
	71, // 21: grpc.CgroupStats.hugetlb_stats:type_name -> grpc.CgroupStats.HugetlbStatsEntry
	20, // 22: grpc.StatsContainerResponse.cgroup_stats:type_name -> grpc.CgroupStats
	21, // 23: grpc.StatsContainerResponse.network_stats:type_name -> grpc.NetworkStats
	55, // 24: grpc.CreateSandboxRequest.storages:type_name -> grpc.Storage
	29, // 25: grpc.CreateSandboxRequest.kernel_modules:type_name -> grpc.KernelModule
	74, // 26: grpc.Interfaces.Interfaces:type_name -> types.Interface
	75, // 27: grpc.Routes.Routes:type_name -> types.Route
	74, // 28: grpc.UpdateInterfaceRequest.interface:type_name -> types.Interface
	34, // 29: grpc.UpdateRoutesRequest.routes:type_name -> grpc.Routes
	55, // 30: grpc.UpdateEphemeralMountsRequest.storages:type_name -> grpc.Storage
	76, // 31: grpc.ARPNeighbors.ARPNeighbors:type_name -> types.ARPNeighbor
	40, // 32: grpc.AddARPNeighborsRequest.neighbors:type_name -> grpc.ARPNeighbors
	48, // 33: grpc.GuestDetailsResponse.agent_details:type_name -> grpc.AgentDetails
	77, // 34: grpc.FSGroup.group_change_policy:type_name -> types.FSGroupChangePolicy
	53, // 35: grpc.Storage.fs_group:type_name -> grpc.FSGroup
	19, // 36: grpc.CgroupStats.HugetlbStatsEntry.value:type_name -> grpc.HugetlbStats
	0,  // 37: grpc.AgentService.CreateContainer:input_type -> grpc.CreateContainerRequest
	1,  // 38: grpc.AgentService.StartContainer:input_type -> grpc.StartContainerRequest
	2,  // 39: grpc.AgentService.RemoveContainer:input_type -> grpc.RemoveContainerRequest
	3,  // 40: grpc.AgentService.ExecProcess:input_type -> grpc.ExecProcessRequest
	4,  // 41: grpc.AgentService.SignalProcess:input_type -> grpc.SignalProcessRequest
	5,  // 42: grpc.AgentService.WaitProcess:input_type -> grpc.WaitProcessRequest
	7,  // 43: grpc.AgentService.UpdateContainer:input_type -> grpc.UpdateContainerRequest
	37, // 44: grpc.AgentService.UpdateEphemeralMounts:input_type -> grpc.UpdateEphemeralMountsRequest
	8,  // 45: grpc.AgentService.StatsContainer:input_type -> grpc.StatsContainerRequest
	9,  // 46: grpc.AgentService.PauseContainer:input_type -> grpc.PauseContainerRequest
	10, // 47: grpc.AgentService.ResumeContainer:input_type -> grpc.ResumeContainerRequest
	32, // 48: grpc.AgentService.RemoveStaleVirtiofsShareMounts:input_type -> grpc.RemoveStaleVirtiofsShareMountsRequest
	23, // 49: grpc.AgentService.WriteStdin:input_type -> grpc.WriteStreamRequest
	25, // 50: grpc.AgentService.ReadStdout:input_type -> grpc.ReadStreamRequest
	25, // 51: grpc.AgentService.ReadStderr:input_type -> grpc.ReadStreamRequest
	27, // 52: grpc.AgentService.CloseStdin:input_type -> grpc.CloseStdinRequest
	28, // 53: grpc.AgentService.TtyWinResize:input_type -> grpc.TtyWinResizeRequest
	35, // 54: grpc.AgentService.UpdateInterface:input_type -> grpc.UpdateInterfaceRequest
	36, // 55: grpc.AgentService.UpdateRoutes:input_type -> grpc.UpdateRoutesRequest
	38, // 56: grpc.AgentService.ListInterfaces:input_type -> grpc.ListInterfacesRequest
	39, // 57: grpc.AgentService.ListRoutes:input_type -> grpc.ListRoutesRequest
	41, // 58: grpc.AgentService.AddARPNeighbors:input_type -> grpc.AddARPNeighborsRequest
	42, // 59: grpc.AgentService.GetIPTables:input_type -> grpc.GetIPTablesRequest
	44, // 60: grpc.AgentService.SetIPTables:input_type -> grpc.SetIPTablesRequest
	63, // 61: grpc.AgentService.GetMetrics:input_type -> grpc.GetMetricsRequest
	68, // 62: grpc.AgentService.MemAgentMemcgSet:input_type -> grpc.MemAgentMemcgConfig
	69, // 63: grpc.AgentService.MemAgentCompactSet:input_type -> grpc.MemAgentCompactConfig
	30, // 64: grpc.AgentService.CreateSandbox:input_type -> grpc.CreateSandboxRequest
	31, // 65: grpc.AgentService.DestroySandbox:input_type -> grpc.DestroySandboxRequest
	46, // 66: grpc.AgentService.OnlineCPUMem:input_type -> grpc.OnlineCPUMemRequest
	47, // 67: grpc.AgentService.ReseedRandomDev:input_type -> grpc.ReseedRandomDevRequest
	49, // 68: grpc.AgentService.GetGuestDetails:input_type -> grpc.GuestDetailsRequest
	51, // 69: grpc.AgentService.MemHotplugByProbe:input_type -> grpc.MemHotplugByProbeRequest
	52, // 70: grpc.AgentService.SetGuestDateTime:input_type -> grpc.SetGuestDateTimeRequest
	58, // 71: grpc.AgentService.CopyFile:input_type -> grpc.CopyFileRequest
	59, // 72: grpc.AgentService.GetOOMEvent:input_type -> grpc.GetOOMEventRequest
	61, // 73: grpc.AgentService.AddSwap:input_type -> grpc.AddSwapRequest
	62, // 74: grpc.AgentService.AddSwapPath:input_type -> grpc.AddSwapPathRequest
	65, // 75: grpc.AgentService.GetVolumeStats:input_type -> grpc.VolumeStatsRequest
	66, // 76: grpc.AgentService.ResizeVolume:input_type -> grpc.ResizeVolumeRequest
	67, // 77: grpc.AgentService.SetPolicy:input_type -> grpc.SetPolicyRequest
	78, // 78: grpc.AgentService.CreateContainer:output_type -> google.protobuf.Empty
	78, // 79: grpc.AgentService.StartContainer:output_type -> google.protobuf.Empty
	78, // 80: grpc.AgentService.RemoveContainer:output_type -> google.protobuf.Empty
	78, // 81: grpc.AgentService.ExecProcess:output_type -> google.protobuf.Empty
	78, // 82: grpc.AgentService.SignalProcess:output_type -> google.protobuf.Empty
	6,  // 83: grpc.AgentService.WaitProcess:output_type -> grpc.WaitProcessResponse
	78, // 84: grpc.AgentService.UpdateContainer:output_type -> google.protobuf.Empty
	78, // 85: grpc.AgentService.UpdateEphemeralMounts:output_type -> google.protobuf.Empty
	22, // 86: grpc.AgentService.StatsContainer:output_type -> grpc.StatsContainerResponse
	78, // 87: grpc.AgentService.PauseContainer:output_type -> google.protobuf.Empty
	78, // 88: grpc.AgentService.ResumeContainer:output_type -> google.protobuf.Empty
	78, // 89: grpc.AgentService.RemoveStaleVirtiofsShareMounts:output_type -> google.protobuf.Empty
	24, // 90: grpc.AgentService.WriteStdin:output_type -> grpc.WriteStreamResponse
	26, // 91: grpc.AgentService.ReadStdout:output_type -> grpc.ReadStreamResponse
	26, // 92: grpc.AgentService.ReadStderr:output_type -> grpc.ReadStreamResponse
	78, // 93: grpc.AgentService.CloseStdin:output_type -> google.protobuf.Empty
	78, // 94: grpc.AgentService.TtyWinResize:output_type -> google.protobuf.Empty
	74, // 95: grpc.AgentService.UpdateInterface:output_type -> types.Interface
	34, // 96: grpc.AgentService.UpdateRoutes:output_type -> grpc.Routes
	33, // 97: grpc.AgentService.ListInterfaces:output_type -> grpc.Interfaces
	34, // 98: grpc.AgentService.ListRoutes:output_type -> grpc.Routes
	78, // 99: grpc.AgentService.AddARPNeighbors:output_type -> google.protobuf.Empty
	43, // 100: grpc.AgentService.GetIPTables:output_type -> grpc.GetIPTablesResponse
	45, // 101: grpc.AgentService.SetIPTables:output_type -> grpc.SetIPTablesResponse
	64, // 102: grpc.AgentService.GetMetrics:output_type -> grpc.Metrics
	78, // 103: grpc.AgentService.MemAgentMemcgSet:output_type -> google.protobuf.Empty
	78, // 104: grpc.AgentService.MemAgentCompactSet:output_type -> google.protobuf.Empty
	78, // 105: grpc.AgentService.CreateSandbox:output_type -> google.protobuf.Empty
	78, // 106: grpc.AgentService.DestroySandbox:output_type -> google.protobuf.Empty
	78, // 107: grpc.AgentService.OnlineCPUMem:output_type -> google.protobuf.Empty
	78, // 108: grpc.AgentService.ReseedRandomDev:output_type -> google.protobuf.Empty
	50, // 109: grpc.AgentService.GetGuestDetails:output_type -> grpc.GuestDetailsResponse
	78, // 110: grpc.AgentService.MemHotplugByProbe:output_type -> google.protobuf.Empty
	78, // 111: grpc.AgentService.SetGuestDateTime:output_type -> google.protobuf.Empty
	78, // 112: grpc.AgentService.CopyFile:output_type -> google.protobuf.Empty
	60, // 113: grpc.AgentService.GetOOMEvent:output_type -> grpc.OOMEvent
	78, // 114: grpc.AgentService.AddSwap:output_type -> google.protobuf.Empty
	78, // 115: grpc.AgentService.AddSwapPath:output_type -> google.protobuf.Empty
...
func file_agent_proto_init() {
	...
	file_agent_proto_msgTypes[69].OneofWrappers = []any{}
	type x struct{}
